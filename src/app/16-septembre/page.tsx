...
export const metadata: Metadata = {
  ...
  description:
    "Nous vous invitons au soir d'Europe du mercredi 16 septembre 2026 à 20h, à La Cour, 23 rue de la Roë à Angers.",
}
...
export default async function SeizeSeptembrePage({
  ...
  return (
    <>
      <PageHeader kicker={site.cafe.name} title="Mercredi 16 septembre">
        On se retrouve mercredi 16 septembre 2026 à 20h, à La Cour, 23 rue de
        la Roë à Angers. Un verre, des conversations, l&apos;Europe telle
        qu&apos;elle se vit ici. Sans invité particulier.
      </PageHeader>
        ...
        <Container className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 text-lg leading-relaxed">
              ...
              matin du 16, du nombre de personnes autour des tables. Si vous

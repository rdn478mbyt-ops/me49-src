        ...
        <Container className="max-w-3xl">
          ...
          <div className="mt-8 space-y-5 text-lg leading-relaxed">
            ...
            <p>
              ...
              d&apos;Europe&nbsp;: à partir du 16 septembre, un mercredi sur
              deux, à 20h, à La Cour. Après quelques soirées, celles et ceux
              qui le souhaitent peuvent contribuer ou porter un projet.
            </p>
          </div>
        </Container>
      </Section>

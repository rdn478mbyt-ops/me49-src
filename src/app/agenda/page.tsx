...
export const metadata: Metadata = {
  title: "Agenda",
  description:
    "Agenda des soirs d'Europe à Angers : un mercredi sur deux à 20h, à La Cour. Prochain rendez-vous : mercredi 16 septembre 2026.",
}
      ...
      <Section className="bg-white">
        <Container>
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground">
            Les mercredis 16 et 30 septembre, 14 et 28 octobre, 11 et
            25 novembre, toujours à 20h
            {venue ? `, à ${venue.name}.` : "."}
          </p>

...
export const metadata: Metadata = {
  ...
  description:
    "Les soirs d'Europe se tiennent un mercredi sur deux à 20h, à La Cour, 23 rue de la Roë à Angers. Prochain rendez-vous : mercredi 16 septembre 2026.",
}
...
export default function NousRencontrerPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "On se retrouve à La Cour. Certains soirs, un invité nous expose un sujet qui pourra par la suite alimenter nos discussions. Le 16 septembre est un soir libre, sans invité.",
    },
    {
      value: "membre",
    ...
    },
    {
      ...
      answer:
        "Pour le 16 septembre, un formulaire court nous aide à prévenir La Cour le matin même. Les dates suivantes sont publiées ici, à l'agenda.",
    },
  ]
          ...
          <div>
            ...
            <p className="mt-4 text-lg leading-relaxed">
              ...
              {cafe.session?.format === "libre" && cafe.session.date === site.registration.eventDate
                ? " Le 16 septembre sera un soir libre, sans invité."
